...
//				projectileTypeLibrary.get("Crescent"), 0f, 0, 0));
		...
		// Enemies
		enemyTypeLibrary.put("Skeleton", new EnemyType(new Texture("img/Skeleton.png"), 100, .5f, 0, 1f, 10, 10));
		enemyTypeLibrary.put("Wight", new EnemyType(new Texture("img/wight.png"), 100, 1f, 0, .6f, 10, 10));
